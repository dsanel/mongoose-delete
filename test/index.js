...
describe("check overridden static methods: { overrideMethods: 'all' }", function () {
  ...
  it("findOneAndUpdateDeleted() -> should find and update deleted document", function (done) {
    TestModel.findOneAndUpdateDeleted(
      { name: "Obi-Wan Kenobi" },
      { name: "Obi-Wan Kenobi Test" },
      { new: true },
      function (err, doc) {
  ...
  it("findOneAndUpdateWithDeleted() -> should find and update deleted document", function (done) {
    TestModel.findOneAndUpdateWithDeleted(
      { name: "Obi-Wan Kenobi" },
      { name: "Obi-Wan Kenobi Test" },
      { new: true },
      function (err, doc) {
  ...
  it("updateOneWithDeleted(conditions, update, options, callback) -> should update first deleted document", function (done) {
    TestModel.updateOneWithDeleted(
      { name: "Luke Skywalker" },
      { name: "Luke Skywalker Test" },
      {},
      function (err, doc) {
  ...
  it("updateManyWithDeleted() -> should update all document", function (done) {
    TestModel.updateManyWithDeleted(
      {},
      { name: "Test 654" },
      { multi: true },
      function (err, doc) {
...
describe("mongoose_delete find method overridden with populate", function () {
  ...
  beforeEach(function (done) {
    TestPopulate1.create(
      [
        {
          name: "Obi-Wan Kenobi",
          _id: ObjectId("53da93b16b4a6670076b16b1"),
          deleted: true,
        },
        { name: "Darth Vader", _id: ObjectId("53da93b16b4a6670076b16b2") },
        {
          name: "Luke Skywalker",
          _id: ObjectId("53da93b16b4a6670076b16b3"),
          deleted: true,
        },
      ],
      function () {
        TestPopulate2.create(
          [
            ...
            {
              name: "Student 3",
              test: ObjectId("53da93b16b4a6670076b16b3"),
              deleted: true,
            },
          ],
          done
  ...
  it("populate() -> should not return deleted sub-document", function (done) {
    TestPopulate2.findOne({ name: "Student 1" })
      .populate({ path: "test" })
